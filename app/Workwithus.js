            ...
            >
              ...
              >
                ...
                <span style={{ fontSize: "18px" }}>
                  At ahead our goal is to make self-<br></br>
                  improvement fun and lasting. We know there's <br></br>a way
                  how to make it work. And that's what <br></br>aHead is all
                  about!
                </span>
              </Paper>
              <Paper
              ...
              >
                ...
                <br></br>
                <span>
                  Sure, you could spend ages reading books or <br></br> sitting
                  in seminars on how to become a better<br></br> spouse, parent,
              ...
              >
                {categories.map((category) => (
                  ...
                  >
                    ...
                    <br></br>
                    <span
                      style={{ opacity: 1, color: "black ", fontSize: "16px" }}
                    >
                      {category.subtitle}
                    </span>
                  </Paper>
