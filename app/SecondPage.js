    ...
    >
      ...
      >
        ...
        <span style={{ color: "grey", fontSize: "20px" }}>
          People with high emotional <br></br>intelligence(EQ) live more
          fulfilled <br></br>lives .they tend to be happier<br></br> have
          lealthier relationships{" "}
        </span>
        <span style={{ color: "grey", fontSize: "20px" }}>
          People with high emotional<br></br> intelligence(EQ) live more
          <br></br> fulfilled lives .they tend to be happier<br></br> have
          lealthier relationships{" "}
        </span>
      </Stack>
